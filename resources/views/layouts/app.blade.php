            ...
            <div class="list-item-menu">
                ...
                <nav class="nav-menu">
                    <ul class="header-menu-list">
                        ...
                        <li class="menu-item active"><a href="/">Servicios</a></li>
                        <li class="menu-item "><a href="/">Sobre nosotros</a></li>
                        <li class="menu-item "><a href="/">Casos de exito</a></li>
                    </ul>
                </nav>
                <button title="Menu" data-toggle="header-mobile-drop" class="header-toggle"><i class="fas fa-bars"></i><span class="sr-only">Menu</span></button>
            </div>
        </header>
        <main>
            @yield('content')
